...
Usage:
  ...
  bloxtool host create mac <mac_address> ipv4addrs <ipv4addrs> hostname <hostname> view <view>[--network-block=""][--delimeter=" "][--format=text][--config=~/.bloxtool.cfg]
  ...
  bloxtool host setmac <mac> hostname <hostname>[--config=~/.bloxtool.cfg][--delimeter=" "][--format=text]
